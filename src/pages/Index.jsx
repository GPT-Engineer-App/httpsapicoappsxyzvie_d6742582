...
const Index = () => {
  const slotMachines = [
    ...
    },
    {
      ...
      description: 'Unveil the myths of ancient civilizations and encounter gods and heroes.',
      image: 'https://images.unsplash.com/photo-ancient-mythology?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080',
    },
    {
      name: 'Ancient Mythology',
      description: 'Unveil the myths of ancient civilizations and encounter gods and heroes.',
  ...
  return (
    <Flex direction="column" align="center" justify="center" minH="100vh" p={4}>
      <Heading mb={4} size="2xl" color="brand.800">Welcome to Double Diamond Casino</Heading>
      <Text fontSize="xl" mb={8}>Enjoy the best online casino games with exciting jackpots, slots, and live dealers.</Text>
      {/* Slot machine games have been removed from the home screen */}
    </Flex>
  );
};
